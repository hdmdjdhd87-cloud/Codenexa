...
export default {
  ...
  theme: {
    extend: {
      ...
      // редизайн. Переход существующих text-[Npx] на text-cn-* —
      // отдельная механическая замена (safe rename, идентичный
      // рендер), не входит в этот коммит.
      //
      ...
      fontSize: {
        "cn-2xs": ["10px", { lineHeight: "14px" }],
        "cn-xs": ["11.5px", { lineHeight: "16px" }],
        "cn-sm": ["12.5px", { lineHeight: "17px" }],
        "cn-base": ["13.5px", { lineHeight: "19px" }],
        "cn-md": ["14px", { lineHeight: "20px" }],
        "cn-lg": ["16px", { lineHeight: "22px" }],
        "cn-xl": ["17px", { lineHeight: "23px" }],
        "cn-2xl": ["20px", { lineHeight: "26px" }],
        "cn-3xl": ["24px", { lineHeight: "30px" }],
      },
